      ...
      <nav class="navbar navbar-default" role="navigation" style="width: 100%;">
        ...
        <div class="collapse navbar-collapse" id="main-menu">
            ...
            <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-mobile" aria-hidden="true"></i>  Iphone<span class="caret"></span></a>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-tablet" aria-hidden="true"></i>  Oppo <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                       <?php   
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-laptop" aria-hidden="true"></i> Sam Sung<span class="caret"></span></a>
                <ul class="dropdown-menu">
                   <?php   
